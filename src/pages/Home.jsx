        ...
        <section className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="w-full md:w-1/2 relative group min-h-[400px] md:min-h-0 mt-12 md:mt-0">
              ...
              <div className="absolute w-[90%] h-[80%] top-[10%] left-[5%] bg-white/60 backdrop-blur-md rounded-[60%_40%_60%_40%/30%_70%_30%_70%] animate-[morphLeftInner_20s_ease-in-out_infinite_alternate] p-4 md:p-8 flex flex-col justify-center transform transition-all duration-700 group-hover:scale-105 group-hover:-rotate-1">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-4 md:mt-6 justify-center">
                  <Link
                    to="/neural-odyssey"
                    className="px-4 py-2 md:px-6 md:py-3 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white shadow-md hover:shadow-lg transition-transform hover:scale-105 flex items-center justify-center text-sm md:text-base"
                  >
                    <span className="group-hover:animate-bounce material-symbols-outlined mr-2 text-base md:text-lg">
                      rocket_launch
                    </span>
                    Start Adventure
                  </Link>
                  <button className="px-4 py-2 md:px-6 md:py-3 bg-white/80 border border-purple-200 text-gray-700 font-semibold hover:bg-white transition-transform hover:scale-105 shadow-md flex items-center justify-center gap-2 text-sm md:text-base">
          ...
          <div className="flex flex-col md:flex-row w-full gap-6 md:gap-10 p-4 md:p-8 h-auto md:h-[600px] overflow-hidden">
            <div className="w-full md:w-1/2 relative group min-h-[400px] md:min-h-0">
              ...
              <div className="absolute w-[90%] h-[80%] top-[10%] left-[5%] bg-white/60 backdrop-blur-md rounded-[60%_40%_60%_40%/30%_70%_30%_70%] animate-[morphLeftInner_20s_ease-in-out_infinite_alternate] p-4 md:p-8 flex flex-col justify-center transform transition-all duration-700 group-hover:scale-105 group-hover:-rotate-1">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-4 md:mt-6 justify-center">
                  <button className="px-4 py-2 md:px-6 md:py-3 bg-gradient-to-r from-blue-600 to-indigo-700 text-white font-semibold hover:from-blue-700 hover:to-indigo-800 hover:scale-105 transition-transform shadow-lg flex items-center justify-center gap-2 text-sm md:text-base">
                    <span>Dive into Challenges</span>
                    <span className="material-symbols-outlined transition-transform text-base md:text-lg">
                      arrow_forward
                    </span>
                  </button>
                  <button className="px-4 py-2 md:px-6 md:py-3 bg-white/80 border border-blue-200 text-gray-700 font-semibold hover:bg-white hover:scale-105 transition-transform shadow-md flex items-center justify-center gap-2 text-sm md:text-base">
                    Try Neural Spirit
                  </button>
                </div>
              ...
              <div className="absolute inset-0 flex flex-col lg:flex-row lg:items-center justify-between px-6 md:px-10 lg:px-16 py-8 lg:py-0 z-10">
                <div className="max-w-full lg:max-w-2xl">
                  ...
                  <p className="text-base md:text-lg text-blue-100 mb-6 md:mb-8 max-w-xl">
                    Connect with like-minded AI enthusiasts, share your
                    projects, learn from experts, and explore the fascinating
                    world of neural networks together.
                  </p>
          ...
          <style jsx>{`
            @keyframes morphLeft {
              ...
              100% {
                border-radius: 30% 70% 30% 70% / 70% 20% 80% 30%;
              }
            }
            @keyframes morphLeftInner {
              ...
              100% {
                border-radius: 20% 80% 20% 80% / 70% 30% 70% 30%;
              }
            }
            @keyframes morphRight {
              ...
              50% {
                border-radius: 50% 50% 50% 50% / 30% 60% 40% 70%;
              }
              75% {
                border-radius: 60% 40% 40% 60% / 40% 70% 30% 60%;
              }
              100% {
                border-radius: 70% 30% 30% 70% / 60% 80% 20% 40%;
              }
            }
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-2">Learning with roadmap</h3>
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                Try our different contextual challenges. A Dark room will be
                added for experts.
              </p>
              <a
                href="#"
                ...
                <div className="flex space-x-8 animate-marquee hover:pause">
                  ...
                  >
                    ...
                    <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                      A major breakthrough in understanding protein folding
                      could significantly accelerate drug discovery and
                      revolutionize structural biology.
                    </p>
                  ...
                  >
                    ...
                    <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                      OpenAI's new model demonstrates unprecedented complex
                      reasoning capabilities, raising questions about the
                      boundary between artificial and human intelligence.
                    </p>
                    <div className="flex justify-between items-center">
                      <span className="text-xs text-gray-500 flex items-center bg-gray-100/80 px-2 py-1 rounded-full">
                        <span className="material-symbols-outlined text-sm mr-1">
                  ...
                  >
                    ...
                    <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                      The rise of generative models is radically transforming
                      visual arts, music, and writing, redefining the boundaries
                      between human and artificial creativity.
                    </p>
                    <div className="flex justify-between items-center">
                      <span className="text-xs text-gray-500 flex items-center bg-gray-100/80 px-2 py-1 rounded-full">
                        <span className="material-symbols-outlined text-sm mr-1">
                  ...
                  >
                    ...
                    <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                      An international study shows that deep learning algorithms
                      now outperform specialist doctors in early identification
                      of certain diseases.
                    </p>
                    <span className="text-xs text-gray-500 flex items-center bg-gray-100/80 px-2 py-1 rounded-full">
                      <span className="material-symbols-outlined text-sm mr-1">
